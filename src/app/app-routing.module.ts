...
const routes: Routes = [
  ...
  {path: 'monitoring', component: MonitorngComponent, canActivate: [RouteGuardService], children: [
      {path: ':id', component: HasilPencarianComponent, canActivate: [RouteGuardService]}
    ]},
